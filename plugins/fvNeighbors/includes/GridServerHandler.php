...
class GridServerHandler {
		...
		function downloadTextFile($fileName,$text){
					$GLOBALS['http_headers'] = 'Content-Length: '.strlen($text) . "\r\n";
					$GLOBALS['http_headers'] .= "Cache-Control: must-revalidate, post-check=0, pre-check=0\r\n";
					$GLOBALS['http_headers'] .= "Content-Type: application/force-download\r\n";
					$GLOBALS['http_headers'] .= "Content-Type: application/octet-stream\r\n";
					$GLOBALS['http_headers'] .= "Content-Type: application/download\r\n";
					$GLOBALS['http_headers'] .= 'Content-Disposition: attachment; filename="'.$fileName.'"' . "\r\n";
					$GLOBALS['http_headers'] .= "Cache-Control: private, max-age=0, must-revalidate\r\n";
					$GLOBALS['http_headers'] .= "Pragma: public\r\n";
